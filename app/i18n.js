...
window.LOCALES={
 ...
 ko:{
  ...
  page:{
   ...
   mypage:{t:'내 정보',d:'계정과 구독을 관리해요.',dMember:'계정 정보를 관리해요.'},
 ...
 en:{
  ...
  page:{
   ...
   mypage:{t:'My Account',d:'Manage your account and subscription.',dMember:'Manage your account.'},
 ...
 ja:{
  ...
  page:{
   ...
   mypage:{t:'マイページ',d:'アカウントとサブスクリプションを管理します。',dMember:'アカウント情報を管理します。'},
 ...
 zh:{
  ...
  page:{
   ...
   mypage:{t:'我的信息',d:'管理账户与订阅。',dMember:'管理账户信息。'},
